    ...
    <>
      ...
      >
        ...
        <div className="sm:flex  pt-8 xl:pt-0 gap-24 lg:h-[214px] relative">
          ...
          <div className="flex flex-col gap-4 pt-3 sm:pt-0 absolute bottom-5 right-[22px]    md:static">
